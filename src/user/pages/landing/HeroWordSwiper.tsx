 ...
 *
 * "등교하면서 / 쉬는 시간에 / … / 자기 전에" 상황 단어(PHRASES)만 위로 흐르고,
 ...
 */
/**
 * 하루 흐름 순서(등교 → 자기 전) — "하루 내내 틈이 있다"는 메시지. 재종 고객 테스트(2026-09-06)에서
 * "등하교·자기 전 같은 상황이 더 다양하게 나오면 좋겠다" 피드백으로 4개 → 8개.
 * 폰(375px)에서 "15분"과 한 줄에 들어가야 하므로 새 문구는 최장 "학원 가기 전에"(7자) 이하로만.
 */
const PHRASES = [
  '등교하면서',
  '쉬는 시간에',
