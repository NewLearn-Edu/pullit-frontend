...
import { consumeOauthState, extractDuplicateAccount, loginWithNaverCode, type DuplicateAccountInfo } from '@/user/api/authApi'
...
export default function NaverCallbackPage() {
  ...
  useEffect(() => {
    ...
    if (state !== consumeOauthState('naver')) {
      setError('네이버 로그인에 실패했어요. 다시 시도해주세요.')
      return
    }
    ...
    warmUpSessionBeforeLogin()
      ...
      .catch((e) => {
        ...
        else setError('네이버 로그인에 실패했어요. 다시 시도해주세요.')
      })
  }, [params, navigate])
