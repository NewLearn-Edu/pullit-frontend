...
/**
 * 맛보기 퍼널(/start · /trial · /trial/quiz) 공용 가드 (2026-08-18 확정 규칙).
 *
 * 퍼널은 "맛보기 미완 유저 전용"이다 — 게스트든 방금 가입한 회원이든 미완이면 통과,
 * 이미 고정 영역(수학 지수와 로그 · 영어 주제)을 완주한 회원만 /home 으로 돌려보낸다.
